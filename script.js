window.addEventListener('DOMContentLoaded', () => {
    ...
    function updateShapeTransparency(binary) {
      shapes.forEach((shape, index) => {
        const alpha = binary[index] === '1' ? 0.5 : 0;
        shape.style.fill = `rgba(255, 0, 0, ${alpha})`;
      });
    }
  
    function animateDisplay() {
      updateShapeTransparency(displayList[currentIndex]);
